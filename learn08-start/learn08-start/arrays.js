function start() {
    ...
    document.getElementById("months").innerHTML = monthPrint;
    ...
    var week = weekday.concat(weekend);
    ...
    document.getElementById("reversed").innerHTML = languages.sort().join(", ");

    // use the compare function to sort the numbers  and print to the num-sorted paragraph
    numbers = [42, 23, 21, 50, 20, 6, 31, 9];

    document.getElementById("num-sorted").innerHTML = numbers.sort((a, b) => a -b).join(", ");
